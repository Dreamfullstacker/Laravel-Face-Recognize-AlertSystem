...
<div class="collapse" id="kt_devs_ask_formatting">
    ...
    <ul class="list-unstyled p-0 mb-10">
        ...
        <li class="py-1 fs-6"><img alt="happy" src="{{ asset(theme()->getMediaUrlPath() . 'smiles/happy.png') }}"/>&nbsp;&nbsp;:)</li>
        <li class="py-1 fs-6"><img alt="shocked" src="{{ asset(theme()->getMediaUrlPath() . 'smiles/shocked.png') }}"/>&nbsp;&nbsp;:|</li>
        <li class="py-1 fs-6"><img alt="sad" src="{{ asset(theme()->getMediaUrlPath() . 'smiles/sad.png') }}"/>&nbsp;&nbsp;:(</li>
    </ul>
</div>
<!--end::Formating info-->
