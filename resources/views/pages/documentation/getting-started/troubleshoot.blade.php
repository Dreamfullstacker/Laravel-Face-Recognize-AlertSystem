...
DB_PASSWORD=
        ...
        <div class="pt-10">
            ...
            If you are using the PHP v8, some plugins are not supported in the latest Laravel version and may cause installation errors. The new <code>--ignore-platform-req</code> option can be used to set specific requirements that Composer can ignore.
        ...
        <div class="pt-10">
            <h2 class="anchor fw-bolder mb-2" id="db-connect">
                <a href="#db-connect"></a>
                Popper Error in Metronic v8.0.33
            </h2>

            <div class="py-5">
                <img src="https://i.postimg.cc/kGQpp10m/popper-error.png" alt="popper-error" class="img-fluid">
            </div>

            Use npm install command with <code>--legacy-peer-deps</code>.
