        ...
        <div class="col-12 col-md-6 col-lg-8">
            ...
            <div class="row justify-content-around">                
                <div class="col-md-3 out-line">
                    ...
                    <p class="ft-12">Matches this week</p>
                </div>
                
                <div class="col-md-3  lost-revenue out-line">
                    <div class="d-flex justify-content-between">
                ...
                <div class="col-md-3 out-line">
                    <p class="ft-16 ft-color-grey" >Cameras online</p>
                    <h1 class="ft-color-black">23</h1>
                    <div class="ups-offline" style="width: fit-content">
                        <img src="images/source_img/lightning-slash.svg" width=25 height=25 >
                        <p class="ft-color-red ft-14" >3 offline</p>
                    </div>
                </div>
