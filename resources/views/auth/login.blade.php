<x-auth-layout>
    ...
    <!--begin::Heading-->
        ...
        <div class="fv-row mb-10">
            ...
            <!--begin::Input-->
            <input class="form-control form-control-lg form-control-solid" type="email" name="email" autocomplete="off" value="{{ old('email', 'susan@email.com') }}" required autofocus/>
            <!--end::Input-->
        </div>
        <!--end::Input group-->
        ...
        <div class="fv-row mb-10">
            ...
            <!--begin::Input-->
            <input class="form-control form-control-lg form-control-solid" type="password" name="password" autocomplete="off" value="qwerQWER1234!@#$" required/>
            <!--end::Input-->
        </div>
        <!--end::Input group-->
